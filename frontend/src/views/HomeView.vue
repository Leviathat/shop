    ...
    <div class="min-h-screen">
        ...
        <div class="w-3/4 mx-auto">
            <div class="w-full text-center py-10 space-y-4">
                ...
                <div class="flex flex-col items-center font-bold font-sans text-xl text-zinc-500">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                <label v-for="category in categories" :key="category.id"
                    ...
                    <div class="group-hover:pr-5 duration-300 inline-flex items-center align-top p-1 justify-end">
